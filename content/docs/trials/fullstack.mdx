...
Após a entrega do sistema, o sistema desenvolvido será avaliado de **1** até **5 pontos** nas seguintes categorias:

| Categoria | Descrição | Peso |
| --- | --- | --- |
| 1. **Boas Práticas** | O código deve ser estruturado em termos de boas práticas, especialmente em relação a repetição (DRY) e organização do código e arquitetura do projeto. | 20% |
...
| 3. **Interface e UI** | O sistema deve atender todos os usuários, desde o garçom até a administração. | 30% |
| 4. **Manutenção** | Os sistemas estão sempre em evolução, acompanhando as melhores práticas de manutenção. | 10% |
